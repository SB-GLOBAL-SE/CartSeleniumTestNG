...
public abstract class BaseTest {
    ...
    public void setUpAppiumDriver() throws IOException {
        DesiredCapabilities desiredCapabilities = getDesiredCapabilitiesFromProperties();DesiredCapabilities capabilities = new DesiredCapabilities();
        desiredCapabilities.setCapability("bitbar_apiKey", "0dab7bc8f183e451adde3ad2f853301c");
        desiredCapabilities.setCapability("bitbar_device", "Apple iPhone 6S A1688 11.2.6");
        desiredCapabilities.setCapability("bitbar_app", "resources/bitbar-ios-sample.ipa");
        desiredCapabilities.setCapability("bitbar_target", "ios");
        desiredCapabilities.setCapability("bitbar_project", "BitbarAndCBT");
        desiredCapabilities.setCapability("platform_name", "iOS");
        desiredCapabilities.setCapability("deviceName", "iPhone device");
        desiredCapabilities.setCapability("automationName", "XCUITest");
        desiredCapabilities.setCapability("app", "com.bitbar.testdroid.bitbarIOSSample");

        /* Remember to change your Appium URL (command executor) to https://appium.bitbar.com/wd/hub/ */
